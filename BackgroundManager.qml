...
//     // 提取到的颜色
//     property color primaryColor: "#1a1a1a"
//     property color secondaryColor: "#2d2d2d"
...
//         console.log("背景颜色已更新:", primaryColor, "->", secondaryColor)
//     }
...
Item {
    ...
    function applyColorsToBackground(colors) {
        ...
        console.log("使用颜色1:", color1, "颜色2:", color2)
    ...
    function updateGradientColors(color1, color2) {
        ...
        Qt.callLater(function() {
            ...
            console.log("背景颜色成功更新:", primaryColor, "->", secondaryColor)
        })
    }
