...
template <> constexpr inline auto FramelessWindow::qt_create_metaobjectdata<qt_meta_tag_ZN15FramelessWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FramelessWindow, qt_meta_tag_ZN15FramelessWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject FramelessWindow::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15FramelessWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15FramelessWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15FramelessWindowE_t>.metaTypes,
    nullptr
} };
...
void *FramelessWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15FramelessWindowE_t>.strings))
